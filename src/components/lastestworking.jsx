      ...
      <div className="bg-[#1f2538] text-white">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20">
          <section aria-label="Portfolio Latest Work" className="mb-20">
            <p className="text-xs text-[#d46a5e] uppercase tracking-widest mb-2 text-center">
              Portfolio
            </p>
            <h2 className="text-3xl font-extrabold text-center mb-6">
              Latest Work
            </h2>
            <nav className="flex justify-center space-x-6 text-xs text-[#7a7a7a] mb-10 font-semibold">
              <button className="relative after:content-['14'] after:absolute after:-top-2 after:-right-3 after:bg-[#1f2538] after:text-[#7a7a7a] after:text-[10px] after:font-semibold after:px-[4px] after:rounded-full">
                Show All
              </button>
            ...
            <div className="grid grid-cols-6 gap-6 max-w-5xl mx-auto">
              <article className="col-span-2 relative rounded-lg overflow-hidden cursor-pointer">
                ...
                />
                <div className="absolute top-85 left-4 bg-white text-[#1f2538] text-[10px] font-semibold rounded-full px-3 py-1 select-none">
                  Design
                </div>
                <h3 className="absolute bottom-4 left-4 text-white text-xl font-extrabold drop-shadow-lg select-none">
                  SOFA
                </h3>
              </article>
          ...
          <section
            ...
            className="bg-[#fff6ef] rounded-lg max-w-5xl mx-auto flex flex-col sm:flex-row items-center h-[316px] justify-between px-15 py-8 gap-6 mb-20"
          >
            <div className="flex flex-col items-start max-w-sm space-y-3">
              <img
                src={icon}
                alt="icon"
                className="h-auto w-auto -mt-[200px]"
              />
              <p className="text-xs text-[#d46a5e] uppercase tracking-widest font-semibold">
                Get Started
              </p>
              <h3 className="text-lg font-extrabold text-[#1f2538]">
                We Help Companies Move Faster
              </h3>
              <button className="bg-[#d46a5e] text-white text-xs font-semibold rounded px-4 py-2 hover:bg-[#b85a4d] transition-colors duration-300">
                Contact Us
              </button>
            </div>
            ...
            <img
              src={block}
              alt="block"
              className="h-full w-auto object-contain -ml-[40px]"
            />

            <div
              className="h-full w-auto bg-no-repeat bg-cover bg-center flex items-end"
          ...
          >
            <p className="text-xs text-[#d46a5e] uppercase tracking-widest mb-2">
              Our Team
            </p>
            <h2 className="text-3xl font-extrabold mb-8 max-w-md">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="border rounded-lg p-4 h-[250px]">
                <img src={azah} alt="azah" className="h-auto w-auto object-contain" />
              </div>
              <p className="font-semibold text-white text-sm mt-3">Azah Anyeni</p>
              <p className="text-xs text-[#7a7a7a] mt-1">Designer</p>
            </div>

            <div className="flex flex-col items-center text-center">
              <div className="border rounded-lg p-4 h-[250px]">
              <img src={roelof} alt="roelof" className="h-auto w-auto"/>
              </div>
              <p className="font-semibold text-white text-sm">
                  Roelof Bekkenenks
                </p>
                <p className="text-xs text-[#7a7a7a] mt-1">React Developer</p>
            </div>

            <div className="flex flex-col items-center text-center">
              <div className="border rounded-lg p-4 h-[250px]">
              <img src={leonardo} alt="leonardo" className="h-auto w-auto"/>
              </div>
              <p className="font-semibold text-white text-sm">
                  Leonardo Oliveira
                </p>
                <p className="text-xs text-[#7a7a7a] mt-1">Illustrator</p>
            </div>

            <div className="flex flex-col items-center text-center">
              <div className="border rounded-lg p-4 h-[250px]">
              <img src={izabella} alt="izabella" className="h-auto w-auto"/>
              </div>
              <p className="font-semibold text-white text-sm">
                  Izabella Tabakova
                </p>
                <p className="text-xs text-[#7a7a7a] mt-1">Product Designer</p>
            </div>

            </div>
            <div className="flex justify-center mt-6 space-x-2">
              <span className="w-2.5 h-2.5 rounded-full bg-[#d46a5e]"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-[#3a3f5c]"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-[#3a3f5c]"></span>
            </div>
          </section>
        </main>
