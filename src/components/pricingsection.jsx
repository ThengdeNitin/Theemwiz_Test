          ...
          <section className="max-w-7xl mx-auto mb-20 md:mb-28">
            ...
            >
              <article className="flex-1 bg-[#F3D1BF] border border-[#E37B65] rounded-md p-6 md:p-7">
                ...
                <h3 className="font-extrabold text-black text-[40px] mb-2">
                  Free
                </h3>
        ...
        <main className="block md:hidden max-w-7xl mx-auto px-6 py-16 md:py-24">
          <section className="max-w-7xl mx-auto mb-20 md:mb-28">
            <div className="max-w-md md:max-w-lg mb-10">
              ...
              <h2 className="text-[40px] font-extrabold text-black leading-[48px] w-[265px] h-[96px]">
            ...
            <div className="flex flex-col md:flex-row max-w-7xl mx-auto" role="list">
              <article className="w-[329px] h-[493px] flex flex-col justify-between bg-[#F3D1BF] border border-[#E37B65] rounded-md p-6 md:p-7">
                <div className="mt-6">
                  <p className="text-[16px] font-semibold tracking-widest text-[#E37B65] w-[142px] h-[32px] mb-2">
                    CONSULTATION
                  </p>
                  <h3 className="font-extrabold text-black text-[40px] w-[93px] h-[48px] mb-6">
                    Free
                  </h3>
                  <p className="text-[16px] text-[#6B5B4B] mb-6 w-[273px] h-[69px] leading-relaxed">
                  ...
                  <ul className="space-y-3 text-sm text-[#6B5B4B]">
                    <li className="flex items-center gap-2">
                      ...
                      <span className="w-[103px] h-[32px]">Brand Design</span>
                    </li>
                    <li className="flex items-center gap-2">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="w-[103px] h-[32px]">Production</span>
                    </li>
                  </ul>
                </div>
                <button
                  type="button"
                  className="mb-6 font-extrabold text-[16px] w-[158px] h-[48px] uppercase bg-white text-[#3B1F0B] px-5 py-2 rounded shadow hover:shadow-lg transition-shadow"
                >
                  Contact Us
                </button>
              </article>
              ...
              <article className="w-[329px] h-[493px] flex flex-col justify-between bg-white border border-[#E37B65] shadow-md rounded-md p-6 md:p-7 relative">
                <span className="absolute top-10 left-4 w-[92px] h-[38px] bg-[#E37B65] text-white text-[16px] font-semibold rounded-full flex items-center justify-center">
                  Popular
                </span>
                <div className="mt-18">
                  <p className="text-[16px] font-semibold tracking-widest text-[#E37B65] uppercase mb-4">
                ...
                <button
                  type="button"
                  className="mt-6 mb-4 font-extrabold text-[16px] w-[158px] h-[48px] uppercase bg-[#E37B65] text-white px-5 py-2 rounded shadow hover:shadow-lg transition-shadow"
                >
                  Contact Us
                </button>
              </article>
              ...
              <article className="w-[329px] h-[493px] flex flex-col justify-between bg-[#F3D1BF] border border-[#E37B65] rounded-md p-6 md:p-7">
                ...
                <button
                  type="button"
                  className="mt-6 mb-4 font-extrabold text-[16px] w-[158px] h-[48px] uppercase bg-white text-[#3B1F0B] px-5 py-2 rounded shadow hover:shadow-lg transition-shadow"
                >
                  Contact Us
                </button>
              </article>
          ...
          <section className="max-w-7xl mx-auto mb-6 flex flex-col md:flex-row gap-12 md:gap-70">
            <div className="max-w-md md:max-w-s">
              ...
              <h2 className="text-[40px] w-[329px] h-[144px] text-[#391400] font-extrabold leading-[48px] mb-4">
                Frequently Asked <br />
                Questions
              </h2>
              <p className="text-[16px] w-[329px] h-[96px] text-[#6B5B4B] mb-6 leading-relaxed max-w-[320px]">
                A digital agency is a business you hire to outsource your
                digital marketing efforts, instead of handling in-house.
              </p>
              <p className="text-[16px] font-extrabold text-[#3B1F0B] cursor-pointer select-none">
