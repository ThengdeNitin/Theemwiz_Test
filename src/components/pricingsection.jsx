      ...
      <div className="bg-[#F3D1BF]">
        <main className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <section className="max-w-7xl mx-auto mb-20 md:mb-28">
            <div className="max-w-md md:max-w-lg mb-12">
              <p className="text-xs font-semibold tracking-widest text-[#E37B65] uppercase mb-2">
                Pricing
              </p>
            ...
            <div className="flex flex-col md:flex-row max-w-4xl mx-auto" role="list">
              <article className="flex-1 bg-[#F3D1BF] border border-[#E37B65] rounded-md p-6 md:p-7">
                <p className="text-xs font-semibold tracking-widest text-[#E37B65] uppercase mb-4">
                  Consultation
                </p>
                <h3 className="font-extrabold text-black text-xl mb-2">Free</h3>
                <p className="text-sm text-[#6B5B4B] mb-6 leading-relaxed">
                ...
                <button
                  type="button"
                  className="font-extrabold text-xs uppercase bg-white text-[#3B1F0B] px-5 py-2 rounded shadow-[0_2px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-shadow"
                >
                  Contact Us
                </button>
              </article>
              ...
              <article className="flex-1 bg-white rounded-md p-4 md:p-7 relative border border-[#E37B65] shadow-md -mt-12 z-10">
                <span className="absolute top-4 left-4 bg-[#E37B65] border-[#E37B65] text-white text-xs font-semibold rounded-full px-3 py-1">
                  Popular
                </span>
                <p className="text-xs font-semibold tracking-widest text-[#E37B65] uppercase mb-4 mt-6">
                  Design
                </p>
                <h3 className="font-extrabold text-black text-xl mb-2">$1500</h3>
                <p className="text-sm text-[#6B5B4B] mb-6 leading-relaxed">
                ...
                <button
                  type="button"
                  className="font-extrabold text-xs uppercase bg-[#E37B65] text-white px-5 py-2 rounded shadow-[0_2px_6px_rgba(0,0,0,0.1)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-shadow"
                >
                  Contact Us
                </button>
              </article>
              ...
              <article className="flex-1 bg-[#F3D1BF] border border-[#E37B65] rounded-md p-6 md:p-7">
                ...
                <h3 className="font-extrabold text-black text-xl mb-2">$2900</h3>
                <p className="text-sm text-[#6B5B4B] mb-6 leading-relaxed">
          ...
          <section className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-90">
            <div className="max-w-md md:max-w-sm">
              ...
              <p className="text-sm text-[#6B5B4B] mb-6 leading-relaxed max-w-[320px]">
                A digital agency is a business you hire to outsource your
                digital marketing efforts, instead of handling in-house.
              </p>
              <p className="text-xs font-extrabold text-[#3B1F0B] cursor-pointer select-none">
                Contact Us
              </p>
            </div>
              ...
              >
                <div className="p-6" role="listitem">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="font-extrabold text-[#3B1F0B] text-base leading-tight max-w-[85%]">
                  ...
                  <p
                    id="faq1"
                    className="text-[#6B5B4B] text-sm leading-relaxed max-w-[90%]"
                  >
                    Digital marketing efforts, instead of handling in-house.
                ...
                <div
                  className="p-6 cursor-pointer flex justify-between items-center !bg-[#F3D1BF] border-[#E37B65]"
                  role="listitem"
                >
                  <h3 className="font-extrabold text-[#3B1F0B] text-base leading-tight max-w-[85%]">
                ...
                <div className="p-6 cursor-pointer flex justify-between items-center !bg-[#F3D1BF] border-[#E37B65]" role="listitem">
                  <h3 className="font-extrabold text-[#3B1F0B] text-base leading-tight max-w-[85%]">
                    Marketing efforts
                  </h3>
                  <button
                ...
                <div
                  className="p-6 cursor-pointer flex justify-between items-center rounded-b-md !bg-[#F3D1BF] border-[#E37B65]"
                  role="listitem"
                >
                  <h3 className="font-extrabold text-[#3B1F0B] text-base leading-tight max-w-[85%]">
