  ...
  return (
    <>
      <div className="bg-[#FAF0E6] text-[#3B1F0B] min-h-screen flex flex-col">
        <header className="border-b border-[#E6D4C3] py-16 px-4 flex justify-center max-w-7xl mx-auto w-full">
          <nav className="flex justify-between items-center w-full max-w-5xl">
            <img src={logo} alt="logo" className="h-full w-auto" />
          </nav>
        </header>
        <main className="flex-grow max-w-7xl  mx-auto w-full px-8 py-16 mt-10">
          ...
          <section className="border border-[#E6D4C3] rounded-md mt-16 mb-25 max-w-7xl mx-auto flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-[#E6D4C3]">
            ...
            <div className="flex-1 p-6 text-center md:text-left">
              <p className="text-[40px] font-extrabold mb-1">5.000</p>
